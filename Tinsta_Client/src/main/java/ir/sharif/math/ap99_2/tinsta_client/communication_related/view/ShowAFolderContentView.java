...
public class ShowAFolderContentView extends JPanel implements ActionListener {
    private final JPanel source;
    private final JButton logoutButton=new JButton("Logout");
    private final JButton backToCommunicationMenuButton =new JButton("Back To Communication Menu");
    private final JTextArea showAFolderContentTextArea = new JTextArea();
    ...
    public ShowAFolderContentView(JPanel source) {
        this.source = source;
    ...
    private JScrollPane configElements(Border border){
        ...
        showAFolderContentTextArea.setFont(showAFolderContentTextArea.getFont().deriveFont(20.0f));
        ...
        showAFolderContentTextArea.setEditable(false);
        showAFolderContentTextArea.setWrapStyleWord(true);
        showAFolderContentTextArea.setOpaque(false);
        showAFolderContentTextArea.setLineWrap(true);


        JScrollPane scrollPane = new JScrollPane(showAFolderContentTextArea);
    ...
    public void setShowAFolderContentTextArea(String showAFolderContentTextArea) {
        this.showAFolderContentTextArea.setText(showAFolderContentTextArea);
    }
