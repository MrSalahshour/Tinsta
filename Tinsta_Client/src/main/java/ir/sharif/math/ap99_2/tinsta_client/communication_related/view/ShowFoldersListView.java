...
public class ShowFoldersListView extends JPanel implements ActionListener {
    private final JPanel source;
    private final JButton logoutButton=new JButton("Logout");
    private final JButton backToCommunicationMenuButton =new JButton("Back To Communication Menu");
    private final JTextArea showFoldersTextArea = new JTextArea();
    ...
    public ShowFoldersListView(JPanel source) {
        this.source = source;
    ...
    private JScrollPane configElements(Border border){
        ...
        showFoldersTextArea.setFont(showFoldersTextArea.getFont().deriveFont(20.0f));
        ...
        showFoldersTextArea.setEditable(false);
        showFoldersTextArea.setWrapStyleWord(true);
        showFoldersTextArea.setOpaque(false);
        showFoldersTextArea.setLineWrap(true);


        JScrollPane scrollPane = new JScrollPane(showFoldersTextArea);
    ...
    public void setShowFoldersTextArea(String showFoldersTextArea) {
        this.showFoldersTextArea.setText(showFoldersTextArea);
    }
