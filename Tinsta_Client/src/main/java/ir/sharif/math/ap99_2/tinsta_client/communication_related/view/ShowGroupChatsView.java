...
public class ShowGroupChatsView extends JPanel implements ActionListener {
    private final JPanel source;
    private final JButton logoutButton=new JButton("Logout");
    private final JButton backToChatRoomMenuButton =new JButton("Back To ChatRoom Menu");
    private final JTextArea showGroupChatsTextArea = new JTextArea();
    ...
    public ShowGroupChatsView(JPanel source) {
        this.source = source;
    ...
    private JScrollPane configElements(Border border){
        ...
        showGroupChatsTextArea.setFont(showGroupChatsTextArea.getFont().deriveFont(20.0f));
        ...
        showGroupChatsTextArea.setEditable(false);
        showGroupChatsTextArea.setWrapStyleWord(true);
        showGroupChatsTextArea.setOpaque(false);
        showGroupChatsTextArea.setLineWrap(true);


        JScrollPane scrollPane = new JScrollPane(showGroupChatsTextArea);
    ...
    public void setShowGroupChatsTextArea(String showGroupChatsTextArea) {
        this.showGroupChatsTextArea.setText(showGroupChatsTextArea);
    }
