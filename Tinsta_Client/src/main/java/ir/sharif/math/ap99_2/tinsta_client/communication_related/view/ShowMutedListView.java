...
public class ShowMutedListView extends JPanel implements ActionListener {
    private final JPanel source;
    private final JButton logoutButton=new JButton("Logout");
    private final JButton backToCommunicationMenuButton =new JButton("Back To Communication Menu");
    private final JTextArea showMutedTextArea = new JTextArea();
    ...
    public ShowMutedListView(JPanel source) {
        this.source = source;
    ...
    private JScrollPane configElements(Border border){
        ...
        showMutedTextArea.setFont(showMutedTextArea.getFont().deriveFont(20.0f));
        ...
        showMutedTextArea.setEditable(false);
        showMutedTextArea.setWrapStyleWord(true);
        showMutedTextArea.setOpaque(false);
        showMutedTextArea.setLineWrap(true);


        JScrollPane scrollPane = new JScrollPane(showMutedTextArea);
    ...
    public void setShowMutedTextArea(String showMutedTextArea) {
        this.showMutedTextArea.setText(showMutedTextArea);
    }
