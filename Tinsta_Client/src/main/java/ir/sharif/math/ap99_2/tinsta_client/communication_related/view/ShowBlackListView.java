...
public class ShowBlackListView extends JPanel implements ActionListener {

    private final JPanel source;
    private final JButton logoutButton=new JButton("Logout");
    private final JButton backToCommunicationMenuButton =new JButton("Back To Communication Menu");
    private final JTextArea showBlockedTextArea = new JTextArea();
    ...
    public ShowBlackListView(JPanel source) {
        this.source = source;
    ...
    private JScrollPane configElements(Border border){
        ...
        showBlockedTextArea.setFont(showBlockedTextArea.getFont().deriveFont(20.0f));
        ...
        showBlockedTextArea.setEditable(false);
        showBlockedTextArea.setWrapStyleWord(true);
        showBlockedTextArea.setOpaque(false);
        showBlockedTextArea.setLineWrap(true);


        JScrollPane scrollPane = new JScrollPane(showBlockedTextArea);
    ...
    public void setShowBlockedTextArea(String showBlockedTextArea) {
        this.showBlockedTextArea.setText(showBlockedTextArea);
    }
